...
const handleLinkConfirm = async () => {
  ...
  try {
    ...
    linkError.value =
      err.data?.error?.message || loginData.social.callback.linkError;
  } finally {
...
onMounted(async () => {
  ...
  if (mode === "link") {
    try {
      const result = await googleLink(code);
  ...
  <div class="social-callback">
    <div class="social-callback__inner">
      ...
      <p
        ...
        class="social-callback__message social-callback__message--error"
      >
        {{ errorMessage }}
      </p>
    </div>
    ...
    <BaseModal
      ...
      :show-close="false"
    >
      <p class="social-callback__link-message">
        {{ loginData.social.linkModal.message }}
      </p>
      <p v-if="linkData" class="social-callback__link-email">
        {{ linkData.email }}
      </p>
      ...
      <p v-if="linkError" class="social-callback__link-error">
        {{ linkError }}
      </p>
